...
namespace RedisHelp
{
    ...
    {
        private static Logger logger = Logger.CreateLogger(typeof(RedisHelper));
        ...
        public Dictionary<string ,  string> GetHashAllKV(string hashid)
        {
            ...
            return Do(db =>
            {
                ...
                RedisValue[] arr1 = db.HashValues(hashid);
